...
exports.createToken = function ( fn, ln, id, em, fav )
{
  return _createToken( fn, ln, id, em, fav );
}
_createToken = function ( fn, ln, id, em, fav )
{
  try
  {
    const expiration = new Date();
    const user = {userId:id,firstName:fn,lastName:ln, email:em, favorites:fav };
